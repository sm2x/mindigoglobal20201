        ...
        <header class="header navbar navbar-expand-sm ">
            ...
            <ul class="navbar-item flex-row ml-md-auto">
                ...
                <?php
                    ...
                    $notifications  = \App\Notification::where('user_id', Auth::user()->id)->where('status', 'unread')->latest()->limit(5)->get();
                ...
                <li class="nav-item dropdown notification-dropdown">
                    ...
                    <span class="text-white font-weight-bold">{{$notifications->count() == 0?'':$notifications->count()}}</span>
                        ...
                        <div class="notification-scroll">
                                    ...
                                    @forelse($notifications as $notification)
                                        ...
                                        <div class="dropdown-item">
                                            <div class="media">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                                                <div class="media-body">
                                                    <div class="notification-para"><span class="user-name">{{$notification->title}}</span> <br>{{$notification->body}} <br>
                                    ...
                                    @empty
                                        ...
                                        <h6 class="font-italic text-center">No messages yet...</h6>
